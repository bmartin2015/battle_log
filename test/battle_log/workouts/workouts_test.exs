defmodule BattleLog.WorkoutsTest do
  use BattleLog.DataCase
  ...
  describe "workouts" do
    ...
    test "create_workout/1 with valid data creates a workout" do
      ...
      assert workout.date == ~N[2010-04-17 14:00:00.000000]
    ...
    test "update_workout/2 with valid data updates the workout" do
      ...
      assert workout.date == ~N[2011-05-18 15:01:01.000000]
